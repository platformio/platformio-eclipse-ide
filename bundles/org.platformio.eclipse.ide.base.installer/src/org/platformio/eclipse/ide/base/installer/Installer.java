 ...
 *******************************************************************************/
package org.platformio.eclipse.ide.base.installer;
...
import org.platformio.eclipse.ide.base.installer.api.PioCoreDistribution;
import org.platformio.eclipse.ide.base.installer.piocore.LocalPioCoreDistribution;
import org.platformio.eclipse.ide.base.installer.python.PythonDistribution;
import org.platformio.eclipse.ide.base.paths.HomeDirectory;
import org.platformio.eclipse.ide.base.python.LocalPython;
import org.platformio.eclipse.ide.base.python.Python;
import org.platformio.eclipse.ide.base.python.PythonsRegistry;

public final class Installer {

	public void install(IProgressMonitor monitor) throws IOException, CoreException {
		Python python = python(monitor);
	...
	public boolean installed(IProgressMonitor monitor) throws CoreException {
		return new LocalPioCoreDistribution(python(monitor)).installed();
	}

	private Python python(IProgressMonitor monitor) throws CoreException {
		...
		return new LocalPython(executable.get());
	}
